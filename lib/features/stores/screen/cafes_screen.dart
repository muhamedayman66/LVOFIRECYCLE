    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var store in storesData) {
          if (store['category']?.toLowerCase() == 'cafes') {
            String imagePath = "assets/images/cafes.jpg"; // Default image
            switch (store['name'].toLowerCase()) {
              case 'cilantro':
                imagePath = "assets/images/cilantroCF.jpg";
                break;
              case 'spectra lounge': // عدلناها من 'spectra' لـ 'spectra lounge'
                imagePath = "assets/images/spectraCF.jpg";
                break;
              case 'princess lounge': // عدلناها من 'princess' لـ 'princess lounge'
                imagePath = "assets/images/princessCF.jpg";
                break;
            }
            cafes.add({
              "name": store['name'],
        ...
        if (cafes.isEmpty) {
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('No cafes available at the moment')),
            );
          }
        }
      } else {
